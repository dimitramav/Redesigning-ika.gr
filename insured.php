    ...
    <div class="container line">
      <ol style="margin-top:80px;" class="breadcrumb">
        ...
        <div class="flex-body">
          ...
          <div class="flex-column" style="margin: 40px;">
            <div class="text-center" style="background: #6d7993; cursor: pointer;" onmouseover="this.style.backgroundColor='#006db9'" onmouseout="this.style.backgroundColor='#6d7993'"><h3 class="padding"><br><br>Δήλωση Έμμεσα Ασφαλισμένων Προσώπων</h3></div>
            <div style="background: #6d7993;">
              <h3 class="padding" style="padding-left:30px;">Θέλεις...</h3>
              <a href="#" class="questions"><p class="padding">να ασφαλίσεις τα αγαπημένα σου πρόσωπα ;</p></a>
            </div>
          </div>
    	</div>
